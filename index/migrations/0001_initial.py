# Generated by Django 2.2 on 2021-03-24 09:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('singer', models.CharField(max_length=50, verbose_name='歌手姓名')),
                ('time', models.CharField(max_length=10, verbose_name='歌曲时长')),
                ('album', models.CharField(max_length=50, verbose_name='所属专辑')),
                ('languages', models.CharField(max_length=20, verbose_name='歌曲语种')),
                ('type', models.CharField(max_length=20, verbose_name='歌曲类型')),
                ('release', models.DateField(verbose_name='发行时间')),
                ('img', models.ImageField(upload_to='songImg/', verbose_name='歌曲图片')),
                ('lyrics', models.FileField(default='暂无歌词', upload_to='songLyric/', verbose_name='歌曲歌词')),
                ('file', models.FileField(upload_to='songFile/', verbose_name='歌曲文件')),
                ('label', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.Label', verbose_name='歌曲标签')),
            ],
            options={
                'verbose_name': '歌曲信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.Song', verbose_name='关联歌曲')),
            ],
            options={
                'verbose_name': '歌曲动态',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.CharField(max_length=20, verbose_name='用户姓名')),
